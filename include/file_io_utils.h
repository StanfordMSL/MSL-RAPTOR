...
namespace rslam_utils {
    void load_rosbag(vector<tuple<double, gtsam::Pose3, gtsam::Pose3, map<string, tuple<gtsam::Pose3, gtsam::Pose3> > > > &raptor_data, //set<double> &times, std::map<std::string, object_est_gt_data_vec_t> &obj_data, 
